    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            int result_bits = std::max(significant_bit_count(), 
        ...
        */
        inline BigUInt operator %(const BigUInt &operand2) const
        {
            ...
            util::Modulus modulus(operand2.data(), operand2.uint64_count(), pool_);
            int result_bits = significant_bit_count();
            BigUInt result(result_bits);
            result = *this;
            int uint64_count = util::divide_round_up(result_bits, util::bits_per_uint64);
            util::modulo_uint_inplace(result.data(), uint64_count, modulus, pool_);
            return result;
        }
        ...
        */
        ...
        {
            int uint64_count = util::divide_round_up(
                bit_count_, util::bits_per_uint64);
            int compare_uint64_count = util::divide_round_up(
                compare.bit_count_, util::bits_per_uint64);
            return util::compare_uint_uint(value_.get(), uint64_count, 
                compare.value_.get(), compare_uint64_count);
        }
        ...
        */
        inline bool operator <(const BigUInt &compare) const
        {
            ...
            int compare_uint64_count = util::divide_round_up(
                compare.bit_count_, util::bits_per_uint64);
            return util::compare_uint_uint(value_.get(), uint64_count, 
                compare.value_.get(), compare_uint64_count) < 0;
        }
