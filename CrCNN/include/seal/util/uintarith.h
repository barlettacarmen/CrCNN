...
namespace seal
{
    namespace util
    {
        inline unsigned char add_uint64_generic(std::uint64_t operand1, 
            std::uint64_t operand2, unsigned char carry, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (result == nullptr)
            {
...
#pragma managed(pop)
        ...
        inline unsigned char add_uint_uint(const std::uint64_t *operand1, 
            int operand1_uint64_count, const std::uint64_t *operand2, 
            int operand2_uint64_count, unsigned char carry, 
            int result_uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
        ...
        inline unsigned char add_uint_uint(const std::uint64_t *operand1, 
            const std::uint64_t *operand2, int uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (uint64_count <= 0)
            {
        ...
        inline unsigned char add_uint_uint64(const std::uint64_t *operand1, 
            std::uint64_t operand2, int uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (uint64_count <= 0)
            {
        ...
        inline unsigned char sub_uint64_generic(std::uint64_t operand1, 
            std::uint64_t operand2, unsigned char borrow, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (result == nullptr)
            {
...
#pragma managed(pop)
        ...
        inline unsigned char sub_uint_uint(const std::uint64_t *operand1, 
            int operand1_uint64_count, const std::uint64_t *operand2, 
            int operand2_uint64_count, unsigned char borrow, 
            int result_uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
        ...
        inline unsigned char increment_uint(const std::uint64_t *operand, 
            int uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (operand == nullptr)
            {
        ...
        inline void negate_uint(const std::uint64_t *operand, int uint64_count, 
            std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (operand == nullptr)
        ...
        inline void left_shift_uint(const std::uint64_t *operand, int shift_amount, 
            int uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (operand == nullptr)
            ...
            int neg_bit_shift_amount = (bits_per_uint64 - bit_shift_amount) & 
                (static_cast<std::uint64_t>(bit_shift_amount == 0) - 1);
        ...
        inline void right_shift_uint(const std::uint64_t *operand, int shift_amount, 
            int uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (operand == nullptr)
            ...
            int bit_shift_amount = shift_amount - uint64_shift_amount * bits_per_uint64;
            int neg_bit_shift_amount = (bits_per_uint64 - bit_shift_amount) & 
                (static_cast<int32_t>(bit_shift_amount == 0) - 1);
        ...
        inline void not_uint(const std::uint64_t *operand, int uint64_count, 
            std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
            if (operand == nullptr && uint64_count > 0)
        ...
        inline void multiply_uint64_generic(std::uint64_t operand1, 
            std::uint64_t operand2, std::uint64_t *result128)
        {
#ifdef SEAL_DEBUG
            ...
            std::uint64_t left = operand1 * operand2
                + (static_cast<uint64_t>(add_uint64(
                    middle1, operand2 * operand1_coeff_right, 0, &middle)) << 32);
        ...
        inline void multiply_uint64(std::uint64_t operand1, std::uint64_t operand2, 
            std::uint64_t *result128)
        {
            SEAL_MULTIPLY_UINT64(operand1, operand2, result128);
        }

        inline void multiply_uint64_hw64_generic(std::uint64_t operand1, 
            std::uint64_t operand2, std::uint64_t *hw64)
        {
#ifdef SEAL_DEBUG
            if (hw64 == nullptr)
            {
        ...
        inline void multiply_uint64_hw64(std::uint64_t operand1, 
            std::uint64_t operand2, std::uint64_t *hw64)
        {
        ...
        void multiply_uint_uint(const std::uint64_t *operand1, 
            int operand1_uint64_count, const std::uint64_t *operand2, 
            int operand2_uint64_count, int result_uint64_count, std::uint64_t *result);
        ...
        void multiply_uint_uint64(const std::uint64_t *operand1, 
            int operand1_uint64_count, std::uint64_t operand2, 
            int result_uint64_count, std::uint64_t *result);
        ...
        void divide_uint_uint_inplace(std::uint64_t *numerator, 
            const std::uint64_t *denominator, int uint64_count, 
        ...
        void exponentiate_uint(const std::uint64_t *operand, 
            int operand_uint64_count, const std::uint64_t *exponent,
