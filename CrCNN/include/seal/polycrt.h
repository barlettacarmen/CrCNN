    ...
    */
    ...
    public:
        ...
        */
        ...
        @throws std::invalid_argument if values is too large
        */
        void compose(gsl::span<const std::uint64_t> values, Plaintext &destination);
        ...
        @throws std::invalid_argument if values is too large
        */
        void compose(gsl::span<const std::int64_t> values, Plaintext &destination);
        ...
        */
        inline void compose(gsl::multi_span<
            const std::uint64_t, 
            static_cast<std::ptrdiff_t>(2),
            gsl::dynamic_range> values, Plaintext &destination)
        {
            compose(gsl::span<const std::uint64_t>(values.data(), values.size()), 
                destination);
        }
        ...
        */
        inline void compose(gsl::multi_span<
            ...
            gsl::dynamic_range> values, Plaintext &destination)
        {
            compose(gsl::span<const std::int64_t>(values.data(), values.size()), 
                destination);
        }
#endif
#endif
        ...
        */
        ...
        @throws std::invalid_argument if plain is not valid for the encryption parameters
        */
        inline void decompose(const Plaintext &plain, 
        ...
        */
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        void decompose(const Plaintext &plain, gsl::span<std::uint64_t> destination, 
            const MemoryPoolHandle &pool);
        ...
        */
        inline void decompose(const Plaintext &plain, 
            gsl::span<std::uint64_t> destination)
        {
            decompose(plain, destination, pool_);
        }
        ...
        @throws std::invalid_argument if pool is uninitialized
        */
        void decompose(const Plaintext &plain, gsl::span<std::int64_t> destination,
            const MemoryPoolHandle &pool);
        ...
        */
        inline void decompose(const Plaintext &plain, 
            gsl::span<std::int64_t> destination)
        {
            decompose(plain, destination, pool_);
        }
#ifdef SEAL_USE_MSGSL_MULTISPAN
        ...
        */
        inline void decompose(const Plaintext &plain, 
            ...
            const MemoryPoolHandle &pool)
        {
            decompose(plain, gsl::span<std::uint64_t>(destination.data(), 
                destination.size()), pool);
        }
        ...
        */
        inline void decompose(const Plaintext &plain, 
            ...
            const MemoryPoolHandle &pool)
        {
            decompose(plain, gsl::span<std::int64_t>(destination.data(), 
                destination.size()), pool);
        }
